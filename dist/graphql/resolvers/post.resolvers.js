...
const createPost = ({ content }, { auth }) => __awaiter(void 0, void 0, void 0, function* () {
...
const getPosts = ({ page = 1, limit = 10, keyword = "" }) => __awaiter(void 0, void 0, void 0, function* () {
...
const getPostsByUser = ({ id = null }) => __awaiter(void 0, void 0, void 0, function* () {
...
const updatePost = ({ postId, content }, { auth }) => __awaiter(void 0, void 0, void 0, function* () {
    if (!(auth === null || auth === void 0 ? void 0 : auth.id))
        return new Error("Auth Required");
...
const deletePost = ({ postId }, { auth }) => __awaiter(void 0, void 0, void 0, function* () {
    if (!(auth === null || auth === void 0 ? void 0 : auth.id))
        return new Error("Auth Required");
